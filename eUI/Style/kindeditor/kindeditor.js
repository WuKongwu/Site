...
KE.setting = {
    ...
    items: [
        ...
        'superscript', 'date', 'time', 'about', '-',
        'title', 'fontname', 'fontsize', 'textcolor', 'bgcolor', 'bold',
        'italic', 'underline', 'strikethrough', 'removeformat', 'selectall', 'image', 'accessory',
...
KE.plugin['accessory'] = {
    ...
    check: function(id) {
        ...
        if (!url.match(/\.(doc|xls|ppt|docx|xlsx|pptx|rar|zip|pdf|jpg)(\s|$)/i)) {
